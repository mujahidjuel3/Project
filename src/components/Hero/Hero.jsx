...
import Image2 from '../../assets/category/virtual.avif';
import Image3 from '../../assets/category/laptops.avif';
                       ...
                       sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                        ...
                        <div className='order-1 sm:order-2'>
                            <div data-aos='zoom-in' data-aos-once='true' className='relative z-10'>
                                ...
                                mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] bg:color-transparent relative z-40'/>
                            </div>
                        </div>
