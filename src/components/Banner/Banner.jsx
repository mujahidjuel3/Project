            ...
            <div style={{backgroundColor:data.bgColor}}
             className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                ...
                <div className='p-6 sm:p-8'>
                 ...
                 {/*second col*/}
                 <div data-aos='zoom-in' className='h-full flex items-center mix-blend-multiply'>
                    <img src={data.image} alt=''className='mix-blend-multiply w-[250px] md:w-[340px]
                  ...
                  <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos='fade-up' data-aos-offsets='0'>
                        <button
